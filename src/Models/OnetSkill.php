...
class OnetSkill extends OnetContentType
{
    protected $table = 'onet_content_model_reference';
    protected $primaryKey = 'element_id';
    public $content_id_range = ['2.A', '2.B'];
    ...
    {
    	$query = $this
            ->belongsToMany(\Eduity\EloquentOnet\Models\OnetOccupation::class, 'onet_skills', 'element_id', 'onetsoc_code');
