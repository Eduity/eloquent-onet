...
class OnetWorkContext extends OnetContentType
{
    protected $table = 'onet_content_model_reference';
    protected $primaryKey = 'element_id';
    public $content_id_range = '4.C';

    /** RELATIONSHIPS */
    public function occupations()
    {
    	return $this->occupations_by_context();
    }

    public function occupations_by_context($atLeast = null)
    {
    	return $this->occupations_by_scale('CX', $atLeast);
    }

    protected function occupations_by_scale($scale, $atLeast = null)
    {
    	$query = $this
            ->belongsToMany(\Eduity\EloquentOnet\Models\OnetOccupation::class, 'onet_work_context', 'element_id', 'onetsoc_code');
